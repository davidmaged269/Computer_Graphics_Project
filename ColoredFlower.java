 ...
 * @author eid.emary
 */
public class ColoredFlower extends JApplet{
...
try{
    img=ImageIO.read(new File("C:\\Users\\David\\Downloads\\PlantPot.jpeg"));
}catch(IOException e){
}
...
try{
    img2=ImageIO.read(new File("C:\\Users\\David\\Desktop\\PlantRoot.jpeg"));// Texture for the plant roots.
}catch(IOException e){   
}
...
try{
    img3=ImageIO.read(new File("C:\\Users\\David\\Desktop\\Plants.jpeg"));// Texture for the plants.
}catch(IOException e){
