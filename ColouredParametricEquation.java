 ...
 * @author eid.emary
 */
public class ColouredParametricEquation extends JApplet{
    ...
    public static void main(String[] args) {
        ...
        JApplet applete =new ColouredParametricEquation();
        applete.init();
...
GradientPaint gp=new GradientPaint(0,0,Color.BLUE,100,100,Color.pink,true); 
